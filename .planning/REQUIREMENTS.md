...
- [ ] **CAL-08**: Calendar lives as a zoom level inside Timeline tab (year to month view)
...
- [ ] **ADV-07**: Point creep detection alerts when draw timelines shift, with specific impact ("Year 5 to Year 6")
...
| SHARE-01 | Phase 2: Shareable Plan Links | Pending |
| SHARE-02 | Phase 2: Shareable Plan Links | Pending |
| SHARE-03 | Phase 2: Shareable Plan Links | Pending |
| SHARE-04 | Phase 2: Shareable Plan Links | Pending |
| SHARE-05 | Phase 2: Shareable Plan Links | Pending |
| SHARE-06 | Phase 2: Shareable Plan Links | Pending |
| SHARE-07 | Phase 2: Shareable Plan Links | Pending |
| CAL-01 | Phase 3: Season Calendar | Pending |
| CAL-02 | Phase 3: Season Calendar | Pending |
| CAL-03 | Phase 3: Season Calendar | Pending |
| CAL-04 | Phase 3: Season Calendar | Pending |
| CAL-05 | Phase 3: Season Calendar | Pending |
| CAL-06 | Phase 3: Season Calendar | Pending |
| CAL-07 | Phase 3: Season Calendar | Pending |
| CAL-08 | Phase 3: Season Calendar | Pending |
| ICS-01 | Phase 4: Calendar Subscription | Pending |
| ICS-02 | Phase 4: Calendar Subscription | Pending |
| ICS-03 | Phase 4: Calendar Subscription | Pending |
| ICS-04 | Phase 4: Calendar Subscription | Pending |
| ICS-05 | Phase 4: Calendar Subscription | Pending |
| ICS-06 | Phase 4: Calendar Subscription | Pending |
| ICS-07 | Phase 4: Calendar Subscription | Pending |
| ICS-08 | Phase 4: Calendar Subscription | Pending |
| ADV-01 | Phase 5: Advisor Voice | Pending |
| ADV-02 | Phase 5: Advisor Voice | Pending |
| ADV-03 | Phase 5: Advisor Voice | Pending |
| ADV-04 | Phase 5: Advisor Voice | Pending |
| ADV-05 | Phase 5: Advisor Voice | Pending |
| ADV-06 | Phase 5: Advisor Voice | Pending |
| ADV-07 | Phase 5: Advisor Voice | Pending |
| ADV-08 | Phase 5: Advisor Voice | Pending |
| API-01 | Phase 6: API Integrations | Pending |
| API-02 | Phase 6: API Integrations | Pending |
| API-03 | Phase 6: API Integrations | Pending |
| API-04 | Phase 6: API Integrations | Pending |
| API-05 | Phase 6: API Integrations | Pending |
| API-06 | Phase 6: API Integrations | Pending |
| API-07 | Phase 6: API Integrations | Pending |
| API-08 | Phase 6: API Integrations | Pending |
| SCRP-01 | Phase 7: Scraper Enrichment & Data Freshness | Pending |
| SCRP-02 | Phase 7: Scraper Enrichment & Data Freshness | Pending |
| SCRP-03 | Phase 7: Scraper Enrichment & Data Freshness | Pending |
| SCRP-04 | Phase 7: Scraper Enrichment & Data Freshness | Pending |
| SCRP-05 | Phase 7: Scraper Enrichment & Data Freshness | Pending |
| SCRP-06 | Phase 7: Scraper Enrichment & Data Freshness | Pending |
| SCRP-07 | Phase 7: Scraper Enrichment & Data Freshness | Pending |
| SCRP-08 | Phase 7: Scraper Enrichment & Data Freshness | Pending |
| SCRP-09 | Phase 7: Scraper Enrichment & Data Freshness | Pending |
| FRESH-01 | Phase 7: Scraper Enrichment & Data Freshness | Pending |
| FRESH-02 | Phase 7: Scraper Enrichment & Data Freshness | Pending |
| FRESH-03 | Phase 7: Scraper Enrichment & Data Freshness | Pending |
| FRESH-04 | Phase 7: Scraper Enrichment & Data Freshness | Pending |
| SAV-01 | Phase 8: Savings & Budget Tracker | Pending |
| SAV-02 | Phase 8: Savings & Budget Tracker | Pending |
| SAV-03 | Phase 8: Savings & Budget Tracker | Pending |
| SAV-04 | Phase 8: Savings & Budget Tracker | Pending |
| SAV-05 | Phase 8: Savings & Budget Tracker | Pending |
| SAV-06 | Phase 8: Savings & Budget Tracker | Pending |
| SAV-07 | Phase 8: Savings & Budget Tracker | Pending |
| DIFF-01 | Phase 9: Diff View | Pending |
| DIFF-02 | Phase 9: Diff View | Pending |
| DIFF-03 | Phase 9: Diff View | Pending |
| DIFF-04 | Phase 9: Diff View | Pending |
| DIFF-05 | Phase 9: Diff View | Pending |
| SCOUT-01 | Phase 10: Scouting Strategy | Pending |
| SCOUT-02 | Phase 10: Scouting Strategy | Pending |
| SCOUT-03 | Phase 10: Scouting Strategy | Pending |
| SCOUT-04 | Phase 10: Scouting Strategy | Pending |
| SCOUT-05 | Phase 10: Scouting Strategy | Pending |
...
*Last updated: 2026-02-21 after roadmap creation (expanded from 7 phases to 10)*
