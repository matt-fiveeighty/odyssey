 ...
 */
function getEstimatedTagCost(stateId: string, speciesId: string): number {
  const tagCosts: Record<string, Record<string, number>> = {
    CO: { elk: 659, mule_deer: 434, bear: 350, moose: 2500 },
    WY: { elk: 707, mule_deer: 457, moose: 1750 },
    MT: { elk: 1200, mule_deer: 1200, bear: 350, moose: 1250, whitetail: 1200 },
    NV: { elk: 1200, mule_deer: 300 },
    AZ: { elk: 800, mule_deer: 300, bear: 250 },
    UT: { elk: 558, mule_deer: 400, bear: 250, moose: 1500 },
    NM: { elk: 783, mule_deer: 350, bear: 250 },
    OR: { elk: 576, mule_deer: 400, bear: 300 },
    ID: { elk: 600, mule_deer: 400, bear: 250, moose: 2000, whitetail: 400 },
    KS: { mule_deer: 442, whitetail: 442 },
  };
